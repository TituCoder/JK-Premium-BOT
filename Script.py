class script(object):
    START_TXT = """<b>♡ 𝙃𝙚𝙮 {}, {}
☞𝗠ʏ 𝗡ᴀᴍᴇ 𝗜𝘀 <a href=https://t.me/{}>{}</a>
◦ᴵᴹ ᴹᴼˢᵀ ᴾᴼᵂᴱᴿᶠᵁᴸ ᴬᵁᵀᴼ ᶠᴵᴸᴸᵀᴱᴿ ᴮᴼᵀ ᵂᴵᵀᴴ ᴾᴿᴱᴹᴵᵁᴹ ᶠᴱᴬᵀᵁᴿᴱˢ. ᴶᵁˢᵀ ᴹᴬᴷᴱ ᴬ ᴹᴱ ᴬᴰᴹᴵᴺ ᴼᶠ ʸᴼᵁᴿ ᴳᴿᴼᵁᴾ..
♡⋆ ☞ 𝘿𝙀𝙑𝙇𝙊𝙋𝙀𝘿 𝘽𝙔 ⋆♡ : <a href=https://t.me/Owner0423_Bot>♡⋆ 𝙈𝙧 𝙅𝙖𝙮𝙣𝙖𝙩𝙝 ⋆♡</a>"""
...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>
✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: 𝗠𝗿 𝗝𝗮𝘆𝗻𝗮𝘁𝗵 𝐕𝟒.𝟐 ⚡
✯ ᴍʏ ʟᴏᴠᴇ: ᴍʏ ᴏᴡɴᴇʀ 🥰
✯ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ: 💥𝗝𝗮𝘆𝗻𝗮𝘁𝗵 𝗠𝗼𝘃𝗶𝗲 𝗖𝗵..💥
✯ ᴍʏ ᴏᴡɴᴇʀ: 𝗠𝗿 𝗝𝗮𝘆𝗻𝗮𝘁𝗵⚡
✯ ʟɪʙʀᴀʀʏ: ɴᴏ ɪᴅᴇᴀ
✯ ʟᴀɴɢᴜᴀɢᴇ: ʜɪɴᴅɪ 🇮🇳
✯ ᴅᴀᴛᴀʙᴀsᴇ: ꜰʀᴇᴇ ᴠᴀʟᴀ 🤫

...
<b><blockquote>ɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏꜰɪʟᴛᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ɢɪᴠᴇ ᴍᴏᴠɪᴇs ᴏʀ sᴇʀɪᴇs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴘᴍ !! 😍</blockquote></b>

<b><spoiler> 🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ :  <a href=http://t.me/Titu_Movie_247_Bot> Mᴀɴᴀɢᴇʀ⚡ </spoiler></b></a>"""

    REFFER_TXT = """
<b>ʀᴇғᴇʀʀᴇ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs, ғᴀᴍɪʟʏ, ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ 1 ᴍᴏɴᴛʜ
ᴛʀᴀɴsʟᴀᴛᴇ 👇
रेफर योर लिंक टू योर फ्रेंड्स, फैमिली, चैनल एंड ग्रुप टू गेट फ्री प्रीमियम फॉर 1 मंथ 
______________________________________
आप लोग बस यह लिंक को कॉपी करके अपने दोस्तो को भेजना है और उनको इतना बोल देना लिंक पर Click करके Start Par Click करना हैं जैसे ही 10 लोग ऐसी करते है आपको प्रीमियम मिल जायेगा 1 month का 
...
ᴛʀᴀɴsʟᴀᴛᴇ 👇
यूनिक यूजर स्टार्ट The बोट विथ योर रेफरल लिंक देन यू विल ऑटोमेटिकली एडेड इन प्रीमियम लिस्ट.
...
❏ डायरेक्ट Bot से मूवी ले सकते है
❏ कोई फाइल लिमिट नही
❏ Send All बटन पर कोई लिमिट नही

==========================
➛ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan

‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ
<i>पेमेंट होने के बाद हमे स्क्रीन शॉट भेजें @Titu_Movie_247_Bot</i>.</b>"""

    GSTART_TXT = """ʜᴇʏ {},\n\nɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴘʀᴇᴍɪᴜᴍ ꜰᴇᴀᴛᴜʀᴇꜱ.\n\nᴍᴀɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="http://t.me/Titu_Movie_247_Bot">Mᴀɴᴀɢᴇʀ⚡</a>"""
...
✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: <a
href=https://t.me/MovieTM0143_Bot>Tɪᴛᴜ 💔  ⚡</a>
✯ ᴍʏ ʟᴏᴠᴇ: <a href=https://t.me/Titu_Movie_Request>ᴍʏ ɢʀᴏᴜᴘs 🥰</a>
✯ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ: <a href=https://t.me/Titu_Movie_Channel>ᴊᴀʏɴᴀᴛʜ ᴍᴏᴠɪᴇ ᴄʜ...</a>
✯ ᴍᴏᴠɪᴇs ɢʀᴏᴜᴘ: <a href=https://t.me/Titu_Movie_Request>ᴍᴏᴠɪᴇs ɢʀᴏᴜᴘs 🥳</a>
✯ ᴍʏ ᴏᴡɴᴇʀ: <a href=https://t.me/Tg_titu>Dᴇᴠʟᴏᴘᴇʀ 🧑‍💻</a>
✯ ᴍʏ ᴍᴀɴᴀɢᴇʀ : <a href="https://telegram.me/Titu_Movie_247_Bot">ᴍᴀɴᴀɢᴇʀ⚡</a>
✯ ʀᴇᴘᴏ : <a href="h">ʟɪɴᴋ</a>
✯ ʟɪʙʀᴀʀʏ: ɴᴏ ɪᴅᴇᴀ
✯ ʟᴀɴɢᴜᴀɢᴇ: ʜɪɴᴅɪ 🇮🇳
✯ ᴅᴀᴛᴀʙᴀsᴇ: ꜰʀᴇᴇ ᴠᴀʟᴀ 🤫
✯ sᴇʀᴠᴇʀ: ꜰʀᴇᴇ ᴠᴀʟᴀ 🤫
✯ ʙᴜɪʟᴅ sᴛᴀᴛᴜs: ᴀᴄᴛɪᴠᴇ ✅</blockquote></b>"""
    ...
    CHANNELS = """
<b><blockquote>⚡ ɢʀᴏᴜᴘs & ᴄʜᴀɴɴᴇʟs ɪɴғᴏ ⚡ 

❏ ᴀʟʟ ɴᴇᴡ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs.
❏ ғᴀsᴛᴇsᴛ ʙᴏᴛs ᴀʀᴇ ᴀᴅᴅᴇᴅ.
❏ ғʀᴇᴇ & ᴇᴀsʏ ᴛᴏ ᴜsᴇ.
❏ ᴏɴʟʏ ᴘʀᴇᴍɪᴜᴍ ᴜꜱᴇʀ ʙᴏᴛ ᴘᴍ ʀᴇᴏ̨ᴜᴇsᴛ ᴍᴏᴠɪᴇs.
❏ 𝙽𝙾𝚁𝙼𝙰𝙻 𝚄𝚂𝙴𝚁 𝙽𝙾𝚃 𝙱𝙾𝚃 𝙿𝙼 𝚁𝙴𝚀𝚄𝙴𝚂𝚃.
❏ 𝟸𝟺x𝟽 sᴇʀᴠɪᴄᴇs ᴀᴠᴀɪʟᴀʙʟᴇ.</blockquote></b>"""

    SOURCE_TXT = """<b><blockquote>ɴᴏᴛᴇ:
- ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ᴀɴ ᴏᴘᴇɴ ꜱᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.
<a href=http://t.me/Titu_Movie_247_Bot>Nhi Dunga 😁</a>
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="http://t.me/Titu_Movie_247_Bot">Mᴀɴᴀɢᴇʀ⚡</a></blockquote></b>"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href=http://t.me/Titu_Movie_247_Bot>Mᴀɴᴀɢᴇʀ⚡</a>"""
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</blockquote></b>"""

    PLAN_TXT = """<b><blockquote>👋 ʜᴇʏ {},
...
‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ.</blockquote></b>"""

    FREE_TXT = """<b><blockquote>👋 ʜᴇʏ {},
...
➛ ᴜꜱᴇ /plans ᴛᴏ ꜱᴇᴇ ᴀʟʟ ᴏᴜʀ ᴘʟᴀɴꜱ ᴀᴛ ᴏɴᴄᴇ.
➛ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan</blockquote></b>"""

    BRONZE_TXT = """<b><blockquote>👋 ʜᴇʏ {},
...
➛ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ ʙʏ ᴜꜱɪɴɢ : /myplan</blockquote></b>"""
    ...
    OTHER_TXT = """<b><blockquote>👋 ʜᴇʏ {},
    
🎁 <u>ᴏᴛʜᴇʀ ᴘʟᴀɴ</u>
⏰ ᴄᴜꜱᴛᴏᴍɪꜱᴇᴅ ᴅᴀʏꜱ
💸 ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ᴅᴀʏꜱ ʏᴏᴜ ᴄʜᴏᴏꜱᴇ

🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='http://t.me/Titu_Movie_247_Bot>Mᴀɴᴀɢᴇʀ⚡</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</blockquote></b>"""
    ...
    QR_TXT = """<b><blockquote>👋 ʜᴇʏ {},
    
⚜️ ᴘᴀʏ ᴀᴍᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ᴘʟᴀɴ ᴀɴᴅ ᴇɴᴊᴏʏ ᴘʀᴇᴍɪᴜᴍ ᴍᴇᴍʙᴇʀꜱʜɪᴘ !

📸 ǫʀ ᴄᴏᴅᴇ - <a href=https://t.me/ImagessDb/2'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>

‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</blockquote></b>"""

    PREPLANS_TXT = """<b><blockquote>👋 ʜᴇʏ {},
    
🎖️ <u>ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs</u> :

● <code>10₹</code> ➛ <u>ʙʀᴏɴᴢᴇ ᴘʟᴀɴ</u> » <code>7 ᴅᴀʏꜱ</code>
● <code>18₹</code> ➛ <u>ꜱɪʟᴠᴇʀ ᴘʟᴀɴ</u> » <code>30 ᴅᴀʏꜱ</code>
● <code>70₹</code> ➛ <u>ɢᴏʟᴅ ᴘʟᴀɴ</u> » <code>90 ᴅᴀʏꜱ</code>
...
★ ᴅᴏɴ'ᴛ ᴡᴀɪᴛ ᴀɴʏ ʟᴏɴɢᴇʀ ᴛᴏ ꜱᴛᴀʀᴛ ᴇᴀʀɴɪɴɢ ᴍᴏɴᴇʏ ꜰʀᴏᴍ ʏᴏᴜʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ. ᴀᴅᴅ ᴏᴜʀ ʙᴏᴛ ᴛᴏᴅᴀʏ ᴀɴᴅ ꜱᴛᴀʀᴛ ᴍᴀᴋɪɴɢ ᴍᴏɴᴇʏ 💰! </blockquote></b>
"""

    SHORTLINK_INFO2 = """<b><blockquote>
...
★ ᴛʜɪꜱ ʙᴏᴛ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴄᴏɴᴠᴇʀᴛꜱ ʟɪɴᴋꜱ ᴡɪᴛʜ ʏᴏᴜʀ ᴀᴘɪ ᴀɴᴅ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ʏᴏᴜʀ ʟɪɴᴋꜱ.</blockquote></b>
"""
    SHORTLINK_INFO3 = """<b><blockquote>
...
★ ᴛʜᴀᴛ'ꜱ ɪᴛ, ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴇᴀʀɴ ᴀ ʟᴏᴛ ᴍᴏɴᴇʏ 💸 ᴜꜱɪɴɢ ᴛʜɪs ʙᴏᴛ.</blockquote></b>
"""
...
BOT {}"""
    ...
    OLD_ALRT_TXT = """<b><blockquote>ए दोस्त ई मैसेज पुराना हो गया है नया मांगो 🤣.</blockquote><b>"""

    CUDNT_FND = """<b><blockquote>मुझे लगता है एस्पेलिंग गलत लिखे हो इनमे से मूवी का नाम चुनो</blockquote><b>"""

    I_CUDNT = """<b><blockquote>अरे बकलोल सिर्फ मूवी का नाम लिखो नाम के आगे कुछ मत लिखो\n\nअगर मूवी का नाम नहीं लिखने आता तो नीचे बटन पर टैप कर के मूवी का नाम देखो 👇👇</blockquote></b>"""

    I_CUD_NT = """<b><blockquote>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ...</blockquote><b>"""

    MVE_NT_FND = """<i><b><blockquote>इस नाम से हमे कोई फिल्म नहीं मिली 🙅,
    
इस फिल्म नाम को एडमिन के पास भेज दिया गया हैं

इस फिल्म को जैसे ही एडमिन अपलोड करते है हम आपको मैसेज करेंगे</blockquote><b></i>..."""

    TOP_ALRT_MSG = """मूवी खोज रहे है 🔍..."""

    MELCOW_ENG = """<b><blockquote>Hᴇʟʟᴏ {} 😍, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ {} Gʀᴏᴜᴘ ❤️</blockquote></b>"""

    OWNER_INFO = """
<b>⍟───[ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ ]───⍟

• ꜰᴜʟʟ ɴᴀᴍᴇ : Mᴀɴᴀɢᴇʀ⚡
• ᴜꜱᴇʀɴᴀᴍᴇ : @Titu_Movie_247_Bot
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/Titu_Movie_247_Bot'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
★ Message <code>{}</code>"""
    ...
    CAPTION = """
<b><blockquote>📂 Fɪʟᴇ ɴᴀᴍᴇ : </b><a href="https://t.me/Titu_Movie_Channel">{file_name}</a></blockquote><b>

मेरे भाई बैकअप चैनल ज्वाइन कर के रखो📥 
पता न कब कॉपीराइट आ जाए 👇
========== • ✠ • ==========
▫️ Backup Channel🤫 :  <a href="https://t.me/Titu_Movie_Request">Click Here</a>
▫️ Request Group🤫 :  <a href="https://t.me/Titu_Movie_Request">Click Here</a>
========== • ✠ • ==========
</b>"""
...
📀 RunTime: {runtime} Minutes</blockquote></b> """
...
ᴀɢᴇ ᴀᴀᴘ ᴄʜᴀʜᴛᴇ ʜᴀɪ ᴋɪ ʙᴏᴛ ᴅᴇᴀᴅ ɴᴀ ʜᴏ ᴀᴜʀ ᴀᴀᴘ ʙʜɪ ᴀᴀɢᴇ ᴇsɪ ᴛᴀʀᴀʜ ᴍᴏᴠɪ Lᴇɴᴀ ᴘᴀɴᴀ ᴄʜᴀᴛᴇ ʜᴀɪ ᴛᴏ 

Kᴜᴄʜʜ Rᴜᴘᴀʏᴇ Dᴏɴᴀᴛ ᴋᴀʀᴇ
<b>━━━━━━━━━᚜ Payment Methods ᚛━━━━━━━━━
✮ 𝗚𝗼𝗼𝗴𝗹𝗲𝗣𝗮𝘆
✮ 𝗣𝗮𝘆𝘁𝗺
✮ 𝗣𝗵𝗼𝗻𝗲𝗣𝗲
...
━━━━━━━━━━━━᚜ <a href=http://t.me/Titu_Movie_247_Bot><b>Mᴀɴᴀɢᴇʀ⚡</b></a> ᚛━━━━━━━━━━━━
...
━━━━━━━━━━━━᚜ <a href=https://t.me/Jaynath_Backup_Channel/15><b>ᴘᴀʏᴍᴇɴᴛ ǫʀ</b></a> ᚛━━━━━━━━━━━━"""
...
✮ 𝗣𝗮𝘆𝗣𝗮𝗹
_𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐌𝐞 𝐖𝐢𝐭𝐡 𝐘𝐨𝐮𝐫 𝐂𝐨𝐧𝐭𝐞𝐧𝐭 𝐀𝐧𝐝 𝐊𝐧𝐨𝐰 𝐀𝐛𝐨𝐮𝐭 𝐓𝐡𝐞 𝐏𝐚𝐲𝐦𝐞𝐧𝐭 𝐈𝐧𝐟𝐨_
━━━━━━━━━━━━᚜ <a href=https://t.me/Titu_Movie_Channel><b>𝓖𝓾𝓡𝓾</b></a> ᚛━━━━━━━━━━━━""" 
...
<code>/batch https://t.me/Titu_Movie_Channell/405 https://t.me/Titu_Movie_Channel/293</code>

𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://t.me/Titu_Movie_Channel><b>Tɪᴛᴜ 💔</b></a>"""
...
<b>✮ Deploy Tutorial ››</b> <i><b>https://t.me/Titu_Movie_Channel</b></i>

<b>𝙸𝙵 𝚈𝙾𝚄 𝚆𝙰𝙽𝚃 𝚃𝙷𝙴 𝗠𝗿 𝗝𝗮𝘆𝗻𝗮𝘁𝗵⚡-𝙿𝚁𝙾-𝙼𝙰𝚇 𝚁𝙴𝙿𝙾 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 <a href=https://t.me/Titu_Movie_Channel>Tɪᴛᴜ 💔</a></b>
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 :- <a href=https://t.me/Titu_Movie_Channel>𝗠𝗿 𝗝𝗮𝘆𝗻𝗮𝘁𝗵⚡</a>"""
...
<b>›› 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 <a href=http://t.me/Titu_Movie_247_Bot>Mᴀɴᴀɢᴇʀ⚡</a></b>"""
...
𝖬𝖺𝖽𝖾 𝖻𝗒 <a href=https://t.me/Titu_Movie_Channel>Tɪᴛᴜ 💔</a>"""

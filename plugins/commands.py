    ...
    try:
        if '480p' in file_name.lower():
            ...
            if not await db.has_premium_access(message.from_user.id):
                ...
                message_text = f"<b>File Name : {file_name}\nYou Can Only Access 480p Quality Files !\nYᴏᴜ Cᴀɴ Oɴʟʏ Aᴄᴄᴇss 𝟺𝟾𝟶ᴘ Qᴜᴀʟɪᴛʏ Fɪʟᴇs !\ɴTᴏ Gᴇᴛ Aʟʟ Qᴜᴀʟɪᴛʏ Fɪʟᴇs Yᴏᴜ Nᴇᴇᴅ Tᴏ Tᴀᴋᴇ Pʀᴇᴍɪᴜᴍ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ !\ɴआप केवल 𝟺𝟾𝟶ᴘ Qᴜᴀʟɪᴛʏ वाली फ़ाइलों ही ले सकते हैं!\ɴसभी Qᴜᴀʟɪᴛʏ वाली फ़ाइलें प्राप्त करने के लिए आपको Pʀᴇᴍɪᴜᴍ लेनी होगी!</b>"

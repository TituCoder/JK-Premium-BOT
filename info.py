...
PICS = (environ.get('PICS', 'https://graph.org/file/e7610575a7a5efca75fde.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001815430242').split()]

...
URL = "https://titumovie.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://titumovie.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://titumovie.koyeb.app/".format(FQDN)
else:
    URL = "https://titumovie.koyeb.app/".format(FQDN)
